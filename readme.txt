...
5. All java files are located under src/test/java
   - com.calculator.java
     BaseFuntion.java: Contain basic Selenium actions
   ...
   - com.calculator.objects  
	 calculatorPage.java: Store objects captured from the calculator page.
	 
   - runner
   	 CucumberRunnerTest.java: This is the cucumber runner class contain cucumber running information
   	 
   - stepDefinitions
   	 TestCalculator.java: Contains all actions to test steps defined in the feature file.  
